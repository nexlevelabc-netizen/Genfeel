    ...
    <section className="relative z-10 bg-cream py-section">
      <div className="container-content">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-start">
          <ScrollReveal>
            <h2 className="font-display text-4xl lg:text-[64px] font-medium text-ink leading-tight">
              Our story
            </h2>
          </ScrollReveal>
          <div>
            <ScrollReveal delay={0.15}>
              ...
              <p className="font-body text-lg text-ink-light leading-relaxed mt-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((v, i) => (
            <ScrollReveal key={v.num} delay={i * 0.15}>
              <div className="bg-white rounded-card p-12 shadow-card h-full">
                <span className="font-display text-[80px] font-medium leading-none" style={{ color: 'rgba(99,102,241,0.12)' }}>{v.num}</span>
                <h3 className="font-display text-[28px] font-medium text-ink -mt-4 mb-3">{v.title}</h3>
                <p className="font-body text-base text-ink-light leading-relaxed">{v.desc}</p>
              </div>
            </ScrollReveal>
          ))}
        </div>
